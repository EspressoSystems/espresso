...
use jf_txn::{
    ...
    proof::transfer::TransferProvingKey,
    sign_receiver_memos,
    structs::{
        AssetCode, AssetCodeSeed, AssetDefinition, AssetPolicy, FeeInput, FreezeFlag, Nullifier,
...
impl<L: Ledger> TransactionState<L> {
    ...
    pub fn find_native_record_for_fee(
        &self,
        owner: &UserPubKey,
        fee: u64,
